...
partial class ColorPickerPanel: VerticalStackPanel
{
	private void BuildUI()
	{
		...
		_hsPicker = new Image();
		_hsPicker.Border = new SolidColorBrush("#000000");
		_hsPicker.BorderThickness = new Thickness(1);
		_hsPicker.Padding = new Thickness(4);
		_hsPicker.HorizontalAlignment = Visuals.HorizontalAlignment.Center;
		_hsPicker.VerticalAlignment = Visuals.VerticalAlignment.Center;
		_hsPicker.IsEnabled = false;
		_hsPicker.Background = new SolidColorBrush("#FFFFFFFF");
		_hsPicker.Id = "_hsPicker";

		var panel1 = new Panel();
		panel1.HorizontalAlignment = Visuals.HorizontalAlignment.Left;
		panel1.VerticalAlignment = Visuals.VerticalAlignment.Top;
		panel1.Widgets.Add(_colorWheel);
		panel1.Widgets.Add(_hsPicker);

		_vPicker = new Slider();
		_vPicker.Orientation = Visuals.Orientation.Vertical;
		_vPicker.Id = "_vPicker";

		_colorBackground = new Image();
		_colorBackground.Width = 40;
		_colorBackground.HorizontalAlignment = Visuals.HorizontalAlignment.Center;
		_colorBackground.VerticalAlignment = Visuals.VerticalAlignment.Stretch;
		_colorBackground.Background = new SolidColorBrush("#FFFFFFFF");
		_colorBackground.Id = "_colorBackground";
		Grid.SetColumnSpan(_colorBackground, 3);

		_colorDisplay = new Image();
		_colorDisplay.Width = 40;
		_colorDisplay.HorizontalAlignment = Visuals.HorizontalAlignment.Center;
		_colorDisplay.VerticalAlignment = Visuals.VerticalAlignment.Stretch;
		...
		_sliderAlpha.Orientation = Orientation.Horizontal;
		...
		label5.Text = "SaveDirect Color";

		_saveColor = new Button();
		_saveColor.HorizontalAlignment = Visuals.HorizontalAlignment.Right;
		...
		grid1.VerticalAlignment = Visuals.VerticalAlignment.Top;
	...
	public Slider _sliderAlpha; // Horizontal

...
public partial class ColorPickerPanel
{
    ...
    public Color Color
    {
        get
        {
            var c = _colorDisplay.Color.Value;
    ...
    public ColorPickerPanel()
    {
        ...
        // Set default value
        _colorDisplay.Visual = Stylesheet.WhiteRegion;
    ...
    internal protected override void OnTouchMove()
    {
        base.OnTouchMove();
        ProcessTouch();
    }
    ...
    {
        _saveColor.IsEnabled = SelectedUserColorIndex != null;
    }
    ...
    private void RgbInputChanged(object sender, EventArgs e)
    {
        ...
        string[] st = _inputRGB.Text.Value.Split(',');
        if (st.Length != 3)
        {
            return;
        }
    ...
    private void HsvInputChanged(object sender, EventArgs e)
    {
        ...
        string[] st = _inputHSV.Text.Value.Split(',');
        if (st.Length != 3)
        {
            return;
        }
    ...
    {
        if (string.IsNullOrEmpty(_inputHEX.Text) || _inputHEX.TextLength < 6)
        {
            return;
        }
    ...
    public override void ApplyFromStyle(Style style)
    {
        ...
        //    {
        //        case "CheckerBoard":
        //            _colorBackground.Visual = value.ConvertTo<ITextureRegion>();
        //            break;
        //        case "SelectionBackground":
        //            _userColors.SelectionBackground = new RegionBrush(value.ConvertTo<ITextureRegion>());
        //            break;
        //        case "SelectionHoverBackground":
        //            _userColors.SelectionHoverBackground = new RegionBrush(value.ConvertTo<ITextureRegion>());
        //            break;
        //        case "Wheel":
        //            _colorWheel.Visual = value.ConvertTo<ITextureRegion>();
        //            break;
        //        case "Gradient":
        //            _vPicker.Background = new RegionBrush(value.ConvertTo<ITextureRegion>());
        //            break;
        //        case "VSPickerKnob":
        //            var vsPickerKnob = (Image)_vPicker.ImageButton.Content;
        //            vsPickerKnob.Visual = value.ConvertTo<ITextureRegion>();
        //            vsPickerKnob.HoveredVisual = vsPickerKnob.Visual;
        //            vsPickerKnob.PressedVisual = vsPickerKnob.Visual;
        //            break;
        //    }
        //});
    }

...
namespace Sachssoft.Sasogine.Resources
{
    public partial class AssetStore
    {
        static AssetStore()
        {
            RegisterLoader<EmbeddedResourceSource>((res, path) => new EmbeddedResourceSource(Path.Combine(res.RootDirectory, path), res.GameApplication.Assembly));
            RegisterLoader<LocalFileSource>((res, path) => new LocalFileSource(Path.Combine(res.RootDirectory, path)));

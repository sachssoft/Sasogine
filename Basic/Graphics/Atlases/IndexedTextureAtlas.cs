...
namespace Sachssoft.Sasogine.Resources
{
    ...
    /// </summary>
    /// <typeparam name="TEnumKey">The enum type used as the key for frames.</typeparam>
    public class IndexedTextureAtlas<TEnumKey> : TextureAtlas where TEnumKey : struct, Enum
    {
        /// <summary>
        ...
        public void AddFrame(TEnumKey key, string frameName)
        {
        ...
        public TextureAtlasFrame this[TEnumKey key] => _enumFrames[key];

        public IReadOnlyDictionary<TEnumKey, TextureAtlasFrame> EnumFrames => _enumFrames;
        ...
        public bool TryCrop(TEnumKey key, [MaybeNullWhen(false)] out Texture2D croppedTexture)
        {

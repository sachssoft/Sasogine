...
namespace Sachssoft.Sasogine.Graphics
{
    public class ParallaxManager
    {
        ...
        public CameraBase? CustomCamera { get; set; }
        ...
        public void Draw(GameFrameContext context)
        {
            ...
            for (int k = 0; k < _currentEntries.Count; k++)
            {
                ...
                {
                    var iMinF = Math.Floor((-tileW - baseX - manualX - scrollX) / stepX);
                    var iMaxF = Math.Ceiling((courseWorldSize.X - baseX - manualX - scrollX) / stepX);
                ...
                {
                    var jMinF = Math.Floor((-tileH - baseY - manualY - scrollY) / stepY);
                    var jMaxF = Math.Ceiling((courseWorldSize.Y - baseY - manualY - scrollY) / stepY);
                    jMin = (int)jMinF - 1;
                    jMax = (int)jMaxF + 1;
                }
                else

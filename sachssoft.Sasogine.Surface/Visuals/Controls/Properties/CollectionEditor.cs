...
public class CollectionEditor : Widget
{
    ...
    {
        _buttonDelete.IsEnabled = _listItems.SelectedIndex >= 0;
        _buttonMoveUp.IsEnabled = _listItems.SelectedIndex > 0;
        _buttonMoveDown.IsEnabled = _listItems.Widgets.Count > 1 && _listItems.SelectedIndex < _listItems.Widgets.Count - 1;
    }

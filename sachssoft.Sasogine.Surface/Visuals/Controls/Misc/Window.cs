...
public class Window : ContentControl
{
    ...
    public void Show(ViewBase view, Point? position = null)
        => Show((Desktop)view.Host, position);
    ...
    public void ShowModal(ViewBase view, Point? position = null)
        => ShowModal((Desktop)view.Host, position);

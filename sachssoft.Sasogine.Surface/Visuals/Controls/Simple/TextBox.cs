...
using sachssoft.Sasogine.Tools;
...
public class TextBox : Widget
{
        ...
        switch (k)
        {
            ...
            case Keys.V:
                if (!Readonly && Desktop.IsControlDown)
                {
                    ...
                    {
                        clipboardText = UIEnvironment.InternalClipboard;
                    }
    ...
    private void Copy()
    {
        if (SelectEnd != SelectStart)
        {
            ...
            {
                UIEnvironment.InternalClipboard = clipboardText;
            }
        }
    }
    ...
    {
        if (!IsEnabled || !IsTouchInside || Length == 0)
        {
            return;
        }
    ...
    public override void InternalRender(RenderContext context)
    {
        ...
        else if (!IsEnabled && DisabledTextColor != null)
        {
        ...
        if (IsEnabled && _cursorOn && Cursor != null)
        {

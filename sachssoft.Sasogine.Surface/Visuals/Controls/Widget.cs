...
public partial class Widget : BaseObject, ITransformable, ISurfaceElement
{
    ...
    SurfaceHost ISurfaceElement.Host => _desktop;
    ...
    public virtual IBrush GetCurrentBackground()
    {
        ...
        else if (IsEnabled && IsKeyboardFocused && FocusedBackground != null)
        {
    ...
    public virtual IBrush GetCurrentBorder()
    {
        ...
        if (!IsEnabled && DisabledBorder != null)
        {
            result = DisabledBorder;
        }
        else if (IsEnabled && IsKeyboardFocused && FocusedBorder != null)
        {
    ...
    public void Render(RenderContext context)
    {
        ...
        if (!string.IsNullOrEmpty(Tooltip) && (Desktop.Tooltip == null || Desktop.Tooltip.Tag != this) &&
            _lastMouseMovement != null && (DateTime.Now - _lastMouseMovement.Value).TotalMilliseconds > UIEnvironment.TooltipDelayInMs)
        {

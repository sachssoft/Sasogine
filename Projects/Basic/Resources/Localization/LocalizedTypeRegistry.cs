...
namespace Sachssoft.Sasogine.Resources.Localization
{
    ...
    {
        private static LocalizedTypeRegistry? _default;
        ...
        public static LocalizedTypeRegistry Default
        {
            get
            {
                if (_default == null)
                {
                    _default = new LocalizedTypeRegistry();

                    _default.Register<LocalizedString>("string");
                    _default.Register<LocalizedResource>("resource");
                }

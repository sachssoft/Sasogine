...
{
    /// <summary>
    /// Provides a strongly typed collection of entities with support for ordered
    /// loading, updating, drawing, and unloading.
    /// </summary>
    /// <typeparam name="TEntity">
    /// The entity type contained in the collection.
    /// </typeparam>
    public class EntityCollection<TEntity> : IList<TEntity>, IList
        where TEntity : IEntity
    {
        ...
        bool IList.Contains(object? value)
            => value is TEntity entity && Contains(entity);
        ...
        int IList.IndexOf(object? value)
            => value is TEntity entity ? IndexOf(entity) : -1;

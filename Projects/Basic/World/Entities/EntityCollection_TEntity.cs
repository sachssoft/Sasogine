...
namespace Sachssoft.Engine.World
{
    ...
    /// support for reference resolution, ordered loading, updating, drawing,
    /// and unloading.
    /// </summary>
    ...
    public class EntityCollection<TEntity, TEntityContext> :
        ContextualReferencableCollection<TEntity, TEntityContext>
        ...
        where TEntityContext : class, IEntityContext
    {
        ...
        /// <see cref="EntityCollection{TEntity, TEntityContext}"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new, empty instance of the
        /// <see cref="EntityCollection{TEntity, TEntityContext}"/> class with
        ...
        /// <see cref="EntityCollection{TEntity, TEntityContext}"/> class
        /// containing the specified entities.
        /// </summary>
        /// <param name="entities">
        ...
        /// The inserted entity.
        /// </param>
        protected override void OnInserted(int index, TEntity item)
        {
            _cacheDirty = true;
        ...
        /// The removed entity.
        /// </param>
        protected override void OnRemoved(int index, TEntity item)
        {
            _cacheDirty = true;
        ...
        /// <summary>
        /// Executes the specified action for all entities in their configured
        /// order.
        /// </summary>
        /// <param name="action">

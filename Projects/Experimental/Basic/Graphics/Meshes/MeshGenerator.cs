...
using Sachssoft.Sasogine.Experimental.Graphics.Meshes.Internal;
using System;
...
public static partial class MeshGenerator
{
    ...
    /// <summary>
    /// Creates a polygon mesh from one or more polygon paths.
    /// </summary>
    /// <param name="graphicsDevice">
    /// The graphics device used to create GPU resources.
    /// </param>
    /// <param name="paths">
    /// The polygon paths used to define the geometry.
    /// Multiple paths can be used to represent polygons with holes.
    /// </param>
    /// <param name="size">
    /// The scale applied to the generated mesh.
    /// </param>
    /// <param name="centerOrigin">
    /// Determines whether the generated mesh is centered around the origin.
    /// If false, the mesh uses the original path coordinates.
    /// </param>
    /// <param name="triangulatorBackend">
    /// The triangulation backend used to convert the polygon paths into triangles.
    /// If null, the default triangulation backend is used.
    /// </param>
    /// <returns>
    /// A GPU mesh containing the triangulated polygon geometry.
    /// </returns>

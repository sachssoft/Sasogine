...
public sealed class ToolVectorCircularArcSegment : ToolVectorFixedSegment
{
    ...
    public ToolVectorCircularArcSegment() : base(1)
    {
    }

    public ToolVectorCircularArcSegment(
        Vector2 position,
    ...
    /// <summary>
    /// Gets the sampled vertices of the circular arc.
    /// </summary>
    ...
    /// <summary>
    /// Calculates the circle passing through three points:
    ...
    /// <summary>
    /// Calculates the number of line segments required
    /// for the requested sampling length.
    /// </summary>

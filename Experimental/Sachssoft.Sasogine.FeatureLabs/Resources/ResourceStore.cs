...
public abstract class ResourceStore : IResourceContainer
{
    ...
    protected ResourceStore(IGameApplication application, ResourceFileSource source, string? rootPath = null)
    {
        _application = application;
        _source = source;
        _rootPath = rootPath;
        _resourceRegistry = CreateRegistry();
        _entries = (new List<IResourceEntry>(GetEntries())).AsReadOnly(); // Immutable !!
    }
    ...
    protected virtual IEnumerable<IResourceEntry> GetEntries()
    {

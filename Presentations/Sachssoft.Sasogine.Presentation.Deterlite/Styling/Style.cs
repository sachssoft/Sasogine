...
namespace Sachssoft.Sasogine.Presentation.Deterlite.Styling
{
    ...
    {
        public Style(string? id, Type targetType, PropertySet properties, IEnumerable<Style>? children = null) : base(id, targetType, properties, children)
        {

        }

        //private readonly Skin _sheet;
        //private readonly Type? _targetType;
        //private readonly Type? _applyForType;
        //private readonly string? _targetId;
        //private readonly Dictionary<string, string> _propertyMap;

        //public Style(Skin sheet, Type? targetType, Type? applyForType, string? targetId, Dictionary<string, string> propertyMap)
        //{
        //    _sheet = sheet;
        ...
        //private protected override Skin GetStylesheet()
        //{
        //    return _sheet;
        //}
